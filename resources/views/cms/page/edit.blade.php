    ...
    <div class="rz-panel">
        ...
        <div id="panelBody">
            ...
            <div class="uk-margin-large">
                ...
                <form class="uk-form-stacked" method="POST" action="{{ route('page.update', $page->id) }}">
                    @csrf
                    @method('PATCH')
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" name="title" id="title" value="{{ $page->title }}" required
                    ...
                    <div class="uk-margin">
                        ...
                        <textarea rows="10" class="uk-textarea content" name="content" id="content" required placeholder="Some text...">{{ $page->content }}</textarea>
                    </div>

                    <div class="uk-margin">
                        <label class="uk-form-label">Meta Title</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" name="meta_title" id="meta_title" value="{{ $page->meta_title }}"
                                type="text" placeholder="Some text...">
                        </div>
                    </div>
                    ...
                    <div class="uk-margin">
                        ...
                        <textarea rows="5" class="uk-textarea" name="meta_description" id="meta_description" placeholder="Some text...">{{ $page->meta_description }}</textarea>
                    </div>
