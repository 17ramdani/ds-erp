                                ...
                                <div class="uk-width-2-3@s">
                                    ...
                                    <div class="uk-child-width-1-2" uk-grid>
                                        <div>
                                            ...
                                            <div class="uk-form-controls">
                                                <input type="text" class="uk-input" name="pob" value="{{ old('pob') }}" placeholder="">
                                            </div>
                                        </div>
                                        <div>
                                            <label class="uk-form-label" for="form-stacked-select">Tanggal Lahir</label>
                                            <div class="uk-form-controls">
                                                <input type="date" class="uk-input" name="dob" value="{{ old('dob') }}" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-form-controls">
                                            <textarea rows="5" class="uk-textarea" name="alamat" value="{{ old('alamat') }}"></textarea>
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                    ...
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-form-controls">
                                            <input type="text" class="uk-input" name="no_ktp" placeholder="" value="{{ old('no_ktp') }}">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Pekerjaan</label>
                                        <div class="uk-form-controls">
                                            <input type="text" class="uk-input" name="pekerjaan" value="{{ old('pekerjaan') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Lama Berusaha</label>
                                        <div class="uk-form-controls">
                                            <input type="text" class="uk-input" name="lama_berusaha" value="{{ old('lama_berusaha') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Omset per Tahun</label>
                                        <div class="uk-form-controls">
                                            <input type="number" class="uk-input" id name="omset" placeholder="" value="{{ old('omset') }}">
                                        </div>
                                    </div>
                                    {{-- </form> --}}
                                </div>
                                ...
                                <div class="uk-width-2-3@s">
                                    ...
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Alamat
                                            Perusahaan* </label>
                                        <div class="uk-form-controls">
                                            <textarea rows="5" class="uk-textarea" name="alamat_perusahaan" value="{{ old('alamat_perusahaan') }}" required></textarea>
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">No Telepon*</label>
                                        <div class="uk-form-controls">
                                            <input type="tel" class="uk-input" name="tlp_perusahaan" value="{{ old('tlp_perusahaan') }}" required placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Email Perusahaan*</label>
                                        <div class="uk-form-controls">
                                            <input type="email" class="uk-input" name="email_perusahaan" value="{{ old('email_perusahaan') }}" required placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Jenis Usaha</label>
                                        <div class="uk-form-controls">
                                            <input type="text" class="uk-input" name="jenis_usaha" value="{{ old('jenis_usaha') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Lama Berdiri
                                            Perusahaan</label>
                                        <div class="uk-form-controls">
                                            <input type="number" class="uk-input" name="lama_berusaha" value="{{ old('lama_berusaha') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Omset per Tahun</label>
                                        <div class="uk-form-controls">
                                            <input type="number" class="uk-input" name="omset_perusahaan" value="{{ old('omset_perusahaan') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Kebutuhan
                                            Nominal</label>
                                        <div class="uk-form-controls">
                                            <input type="number" class="uk-input" name="kebutuhan_nominal" value="{{ old('kebutuhan_nominal') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select">Referensi</label>
                                        <div class="uk-form-controls">
                                            <input type="text" class="uk-input" name="referensi" value="{{ old('referensi') }}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="uk-margin">
