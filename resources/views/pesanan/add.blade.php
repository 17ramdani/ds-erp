                ...
                <div>
                    <form class="uk-form-stacked uk-position-relative">
                        ...
                        <div class="uk-margin" id="barang-list" hidden>
                            <div id="kain1" class="uk-margin">
                                <div id="kain1_display">
                                    {{-- {{  }} --}}
                                    <img id="imgid" src="https://duniasandang.com/wp-content/uploads/2022/01/combed-30s-dunia-sandang-1.jpg"
                                        alt="">
                                </div>
                        ...
                        <div class="uk-margin-medium-top uk-child-width-1-2@s" uk-grid>
                            <div>
                                <a href="#modalWhiteList" class="uk-button uk-border-rounded uk-button-default uk-margin-small-right" uk-toggle><span
                                        class="uk-margin-small-right" uk-icon="heart"></span>Wishlist
        ...
        <script>
            ...
            $('#tipe_kain').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $.each(response.datas, function(i, item) {
                            option += `<option value="${item.kategori_warna_id}">${item.kategoriwarna.nama}</option>`;
                        });
