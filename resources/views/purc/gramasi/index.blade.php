                        ...
                        <div class="uk-margin-medium">
                            <div class="uk-grid-small" uk-grid>
                                <div class="uk-width-expand">
                                    <input type="text" class="uk-input" id="cari" placeholder="Search Gramasi">
                                </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="uk-iconnav">
                                                    <li><a href="{{ route('gramasi.edit', ['id' => $item->id]) }}"
                                                            title="Edit" uk-icon="icon: file-edit"></a>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('gramasi.destroy', ['id' => $item->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
