                ...
                <div class="">
                    ...
                    <div class="rz-panel">
                        ...
                        <div class="uk-flex uk-flex-between">
                            <div>
                                <h4>List Barang Bagian</h4>
                            </div>
                            <div>
                                <a href="{{ route('bagian.add') }}"
                        ...
                        <div class="uk-margin-medium">
                            <div class="uk-grid-small" uk-grid>
                                <div class="uk-width-expand">
                                    <input type="text" class="uk-input" id="cari" placeholder="Search Bagian">
                                </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="uk-iconnav">
                                                    <li><a href="{{ route('bagian.edit', ['id' => $item->id]) }}"
                                                            title="Edit" uk-icon="icon: file-edit"></a>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('bagian.destroy', ['id' => $item->id]) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
